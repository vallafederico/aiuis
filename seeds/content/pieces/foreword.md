...
None of what follows assumes that AI interfaces are inherently good for users, or that more of the technology is automatically the right design choice. Several chapters argue for restraint: not streaming when a static answer would be clearer, not personifying a system that has no persistent self, not hiding uncertainty behind confident prose. The thesis is optimistic about the medium and skeptical of most of what has shipped in it so far; those two positions are not in tension, and holding both at once is, in a sense, the whole argument.
