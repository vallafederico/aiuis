// shooosh hot-reloads like solid components — items/screens rebuild
...
// goes blank. Full-reload for those folders only.
const isGlCore = (file) =>
  /shooosh\/package\/src\/(engine|scene)\//.test(file.replace(/\\/g, "/"));
