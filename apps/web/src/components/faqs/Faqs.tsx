...
import { For, createSignal, Accessor, createEffect, onMount } from "solid-js";
...
function DropdownItem({
  ...
  const [state, setState] = createSignal<"visible" | "hidden">(initialState);
  ...
  return (
    <div ref={item} data-an="faq_appear">
